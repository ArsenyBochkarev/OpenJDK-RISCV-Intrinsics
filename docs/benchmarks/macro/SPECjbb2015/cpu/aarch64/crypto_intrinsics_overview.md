...
The list of disabled crypto intrinsics used in SPECjbb2015 benchmark on board with aarch64 architecture:
...
The list of enabled crypto intrinsics used in SPECjbb2015 benchmark on board with aarch64 architecture:
